...
const updateProdutoDB = async (body) => {
    try {
        ...
        const results = await pool.query(`UPDATE produtos set nome = $2, descricao = $3, quantidade_estoque = $4, ativo = $5, valor = $6, data_cadastro = $7, categoria = $8 where codigo = $1 
        returning codigo, nome`,
...
const getProdutoPorCodigoDB = async (codigo) => {
    try {
        ...
        throw "Erro ao consultar o produto: " + err;
    }
}
